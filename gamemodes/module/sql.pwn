...
,EXP INT(3) NOT NULL) ENGINE=INNODB"

#define SQL_USER_TABLE_2 "\
ALTER TABLE user_info \
ADD(KILLS INT(5) NOT NULL \
...
ALTER TABLE user_info \
ADD(POS_X DECIMAL (10,5) NOT NULL \
...
,SKIN INT(3) NOT NULL) ENGINE=INNODB"

#define SQL_ZONE_TABLE "\
CREATE TABLE zone_info( \
ID INT PRIMARY KEY AUTO_INCREMENT \
,OWNER_CLAN INT(3) NOT NULL) ENGINE=INNODB"
...
,LEAVE_POS_Z DECIMAL (10,5) NOT NULL) ENGINE=INNODB"
